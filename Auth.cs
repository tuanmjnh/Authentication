...
namespace Authentication
{
    public class Auth
    {
        private const string SSAuth = "Auth";
        ...
        public static Users SetAuth(Users Users)
        {
            try
            {
                System.Web.HttpContext.Current.Session[SSAuth] = Users;
                return Users;
            }
        ...
        public static Users AuthUser
        {
            ...
            get
            {
                try
                {
                    var rs = (Users)System.Web.HttpContext.Current.Session[SSAuth];
        ...
        public static bool isAuth
        {
            get
            {
                if (System.Web.HttpContext.Current.Session[SSAuth] != null)
                    return true;
                return false;
            }
        }
        ...
        {
            try { System.Web.HttpContext.Current.Session[SSAuth] = null; }
            catch (Exception) { throw; }
        }
        ...
        public static Users isAuthStatic(string username, string password)
        {
            ...
            {
                if (item.username == username && item.password == TM.Encrypt.CryptoMD5TM(password + item.salt))
                {
                    return item;
                }
            }
